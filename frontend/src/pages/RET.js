  ...
  const dadosEstimativa = useMemo(() => {
    ...
    return {
      ...
      real: {
        ...
        pis_debitos: (dadosAcumulado.real?.pis_debitos || 0) * fator,
        cofins_debitos: (dadosAcumulado.real?.cofins_debitos || 0) * fator,
        pis_creditos: (dadosAcumulado.real?.pis_creditos || 0) * fator,
        cofins_creditos: (dadosAcumulado.real?.cofins_creditos || 0) * fator,
