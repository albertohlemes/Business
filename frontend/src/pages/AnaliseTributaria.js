  ...
  return (
    <Layout user={user} onLogout={onLogout}>
      <div data-testid="analise-tributaria-page" className="space-y-6">
            ...
            <div className="flex gap-3">
              {analysis && (
                <button
                  ...
                  className="px-4 py-2 bg-[#141414]/20 hover:bg-[#141414]/30 rounded-lg font-semibold flex items-center gap-2"
                >
              ...
              <button
                ...
                className="px-6 py-2 bg-[#141414] text-red-600 rounded-lg font-bold hover:bg-gray-100 disabled:opacity-50 flex items-center gap-2"
              >
                {loading ? (
                  <>
        ...
        {/* Info Card */}
        {selectedCompany && (
          <div className="bg-[#141414] rounded-xl p-4 shadow-md border border-[#2A2A2A]100 flex items-center justify-between flex-wrap gap-4">
            <div>
          ...
          <div className="bg-[#141414] rounded-xl shadow-md border border-[#2A2A2A]100 overflow-hidden">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-[#0C0C0C] p-4 rounded-xl text-center">
                  <p className="text-sm text-[#E0E0E0]">PIS/COFINS Tributado</p>
              ...
              <div className="bg-[#0C0C0C] p-4 rounded-xl">
                <p className="font-semibold text-[#E0E0E0] mb-3">Vendas por Tributação ICMS</p>
            ...
            <div className="bg-[#141414] rounded-xl shadow-md border border-[#2A2A2A]100 overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                <div className="bg-green-50 p-3 rounded-lg">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">ST (não gera crédito)</span>
                    <span className="text-[#A1A1AA]">R$ {dados.creditos.icms_st_sem_credito.toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
                <div className="bg-blue-50 p-3 rounded-lg">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Alíquota Zero (CST 73)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.creditos.pis_aliquota_zero || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Sem Incidência (CST 98)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.creditos.pis_sem_incidencia || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
                <div className="bg-purple-50 p-3 rounded-lg">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Alíquota Zero (CST 73)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.creditos.cofins_aliquota_zero || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Sem Incidência (CST 98)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.creditos.cofins_sem_incidencia || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#141414] rounded-xl shadow-md border border-[#2A2A2A]100 overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                <div className="bg-red-50 p-3 rounded-lg">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">ST</span>
                    <span className="text-[#A1A1AA]">R$ {dados.debitos.icms_st.toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Isento</span>
                    <span className="text-[#A1A1AA]">R$ {dados.debitos.icms_isento.toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
                <div className="bg-orange-50 p-3 rounded-lg">
                  <p className="text-sm font-semibold text-orange-800">PIS</p>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-orange-700">Base Tributada</span>
                    <span className="font-bold text-orange-900">R$ {(dados.debitos.pis_base || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-orange-700">Débito Calculado (1.65%)</span>
                    <span className="font-bold text-orange-900">R$ {(dados.debitos.pis_calculado || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Alíquota Zero (CST 06)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.debitos.pis_aliquota_zero || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Sem Incidência (CST 49)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.debitos.pis_sem_incidencia || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
                <div className="bg-yellow-50 p-3 rounded-lg">
                  <p className="text-sm font-semibold text-yellow-800">COFINS</p>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-yellow-700">Base Tributada</span>
                    <span className="font-bold text-yellow-900">R$ {(dados.debitos.cofins_base || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-yellow-700">Débito Calculado (7.6%)</span>
                    <span className="font-bold text-yellow-900">R$ {(dados.debitos.cofins_calculado || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Alíquota Zero (CST 06)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.debitos.cofins_aliquota_zero || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="text-sm text-[#A1A1AA]">Sem Incidência (CST 49)</span>
                    <span className="text-[#A1A1AA]">R$ {(dados.debitos.cofins_sem_incidencia || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {analysis?.ponto_equilibrio && (
          <div className="bg-[#141414] rounded-xl shadow-md border border-[#2A2A2A]100 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-[#A1A1AA] mt-4 text-center">
        ...
        {analysis?.alertas?.length > 0 && (
          <div className="bg-[#141414] rounded-xl shadow-md border border-[#2A2A2A]100 overflow-hidden">
            <div className="bg-[#0C0C0C] px-6 py-4 border-b border-[#2A2A2A]200">
              <h3 className="font-bold text-white flex items-center gap-2">
        ...
        {/* Estado vazio */}
        {!analysis && !loading && (
          <div className="bg-[#141414] rounded-xl p-12 text-center shadow-md">
            <Brain className="w-20 h-20 text-gray-300 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">Análise Tributária por IA</h3>
