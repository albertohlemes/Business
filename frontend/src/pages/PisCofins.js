      ...
      <div className="space-y-6">
        ...
        >
          <div className="space-y-4">
            ...
            {apuracao.por_cst && apuracao.por_cst.entradas_por_cst && apuracao.por_cst.entradas_por_cst.length > 0 && (
              <div className="bg-[#0C0C0C] rounded-lg p-4">
                ...
                {(() => {
                  const entradas = apuracao.por_cst.entradas_por_cst;
                  ...
                  return (
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        ...
                        <tbody>
                          {entradas.sort((a, b) => b.valor_base - a.valor_base).map((item, idx) => (
                            <tr key={idx} className="border-b border-[#1A1A1A] hover:bg-[#1A1A1A]">
                              ...
                              <td className="py-2 px-3 text-right text-green-400">{formatCurrency(item.valor_pis)}</td>
                              <td className="py-2 px-3 text-right text-green-400">{formatCurrency(item.valor_cofins)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
