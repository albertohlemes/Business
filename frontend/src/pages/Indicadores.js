              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="bg-gradient-to-br from-blue-900/30 to-blue-950/30 border border-blue-500/30 rounded-xl p-5">
                    ...
                    <p className="text-2xl font-bold text-blue-400">{formatCurrency(dados?.icms?.saidas?.totais?.valor_total || receitas.total)}</p>
                  </div>
                  
                  {/* Card Vendas Líquidas - Oculto para empresas de serviços */}
                  {selectedCompany?.tipo_atividade !== 'servicos' && (
                    <div className="bg-gradient-to-br from-green-900/30 to-green-950/30 border border-green-500/30 rounded-xl p-5">
                      <div className="flex items-center gap-3 mb-2">
                        <DollarSign className="w-6 h-6 text-green-400" />
                        <span className="text-[#A1A1AA]">Vendas Líquidas</span>
                      </div>
