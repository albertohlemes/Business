      ...
      <div data-testid="users-page" className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-2">
            {user?.role === 'admin' && (
              <button
                data-testid="cleanup-users-button"
                onClick={handleCleanupInactiveUsers}
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-600/20 text-red-400 border border-red-600/30 rounded font-medium hover:bg-red-600/30 transition-all"
                title="Excluir usuários inativos e de teste"
              >
